...
public:
    BobaOrder(string name, string date, string phone, float miles, string sName);   //constructor for class
    ...
    void addDrink(string dName, bool boba = true, int count = 1);                   //will update the order balance based on the input drink name and boba and the number of drinks 
};
